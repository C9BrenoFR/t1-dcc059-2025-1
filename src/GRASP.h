...
{
public:
    static vector<char> conjunto_dominante_independente_grasp(Grafo *grafo, int max_iteracoes = 100, int tamanho_lrc = 3, bool busca_local = true);
...
private:
    ...
    static vector<char> construir_solucao_gulosa_randomizada(Grafo *grafo, int tamanho_lrc, mt19937 &gerador);
